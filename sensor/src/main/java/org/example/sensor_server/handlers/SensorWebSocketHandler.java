...
public class SensorWebSocketHandler extends TextWebSocketHandler {
    ...
    private static final ConcurrentHashMap<String, ConcurrentWebSocketSessionDecorator> clients = new ConcurrentHashMap<>();

    @Override
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        clients.put(session.getId(), (ConcurrentWebSocketSessionDecorator) session);
